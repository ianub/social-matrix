...
http://bootsnipp.com/snippets/x8Dbm
	...
	{{-- <div class="services-btn">
		<div class="col-xs-12">
			...
			<button type="button" class="btn btn-default">AUDIENCE GROWTH</button>
			<button type="button" class="btn btn-default">CONTENT CULTURE</button>
			<button type="button" class="btn btn-default">CONTENT PRODUCTION</button>
		</div>
	</div>
